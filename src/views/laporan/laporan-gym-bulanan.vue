...
import { HomeNavbar, useRouter,  $toast, defineComponent, BackButton ,ref } from '@/plugins/global.js'
  ...
  export default defineComponent({  
    ...
    computed: {
  totalRowCount() {
    return this.dataLaporan.reduce((total, row) => total + row.count, 0);
  }
}
...
<template >
  <header>
    <home-navbar :message="'Gofit - Laporan Gym Bulanan'"></home-navbar>
  </header>
  <main>
    <div class="container mt-5">
      ...
      <div class="content bg-white text-dark table-custom m-5 mt-2">
        <div  class="container-fluid  p-4">
            <h3 >Tabel Laporan Gym Bulanan</h3>
